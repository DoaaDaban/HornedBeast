...
render(){
    ...
    return(
        <main>
            <HornedBeasts title={"UniWhal"}  imgUrl={"http://3.bp.blogspot.com/_DBYF1AdFaHw/TE-f0cDQ24I/AAAAAAAACZg/l-FdTZ6M7z8/s1600/Unicorn_and_Narwhal_by_dinglehopper.jpg" }
